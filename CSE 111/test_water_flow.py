#My exceeding of requirements can be found in lines 2-4 of the water_flow.py file with constants defined and used thoughout the program.
...
def test_pressure_loss_from_price_reduction():
